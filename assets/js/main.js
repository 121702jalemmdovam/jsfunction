...
//     let newarray=results.find(item=>item.id===a);
...
//    function obyekt(x) {
//    let newarray=results.filter(item=>item.shipAddress.country===x);
//    console.log(newarray);
//    }

// 3.ID-ə görə shipName , Country və City tapan function yazın.

// function idnewFunction(a) {
//     let newarray=results.find(item=>item.id===a);
...
//       let resultsArray=results.find(item=>item.id===a);
//       console.log(resultsArray.details);  
// }
